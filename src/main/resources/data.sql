...
INSERT INTO tutorial(created_by_channel_channel_id, creation_time,dislikes,likes,tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1,now(),0,0,1,2,'Do a backflip','Picture yourself standing at the edge of a pristine lake. The sun is setting, casting a golden glow across the water. The air is crisp and filled with the sound of nature.' );
...
INSERT INTO tutorial(created_by_channel_channel_id, creation_time, dislikes, likes, tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1, now(), 0, 0, 2, 9, 'Einen Garten anlegen', 'Wählen Sie Pflanzen aus, die in Ihrem Klima gedeihen, und bereiten Sie den Boden gut vor. Pflanzen Sie Blumen, Gemüse oder Kräuter und genießen Sie Ihren eigenen kleinen Garten.');

INSERT INTO tutorial(created_by_channel_channel_id, creation_time, dislikes, likes, tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1, now(), 0, 0, 4, 10, 'Einen Kuchen backen', 'Finden Sie ein Rezept, das Ihnen gefällt, und folgen Sie den Anweisungen sorgfältig. Bald können Sie einen leckeren Kuchen aus dem Ofen holen und genießen.');

INSERT INTO tutorial(created_by_channel_channel_id, creation_time, dislikes, likes, tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1, now(), 0, 0, 2, 11, 'Meditation praktizieren', 'Finden Sie einen ruhigen Ort und setzen Sie sich bequem hin. Konzentrieren Sie sich auf Ihre Atmung und lassen Sie Ihre Gedanken zur Ruhe kommen.');
...
INSERT INTO tutorial(created_by_channel_channel_id, creation_time, dislikes, likes, tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1, now(), 0, 0, 1, 14, 'Einen Berg besteigen', 'Bereiten Sie sich gut vor und trainieren Sie Ihre Ausdauer. Wählen Sie eine Route, die Ihrem Können entspricht, und genießen Sie das Abenteuer.');

INSERT INTO tutorial(created_by_channel_channel_id, creation_time, dislikes, likes, tutorial_category_category_id, tutorial_id, title, content_Text) 
values (1, now(), 0, 0, 2, 15, 'Ein Aquarium einrichten', 'Wählen Sie die richtige Größe und Ausstattung für Ihre Fische. Pflegen Sie das Aquarium regelmäßig, um eine gesunde Umgebung zu gewährleisten.');
